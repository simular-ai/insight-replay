#!/usr/bin/python
# =============================================================================
# Multi-node cluster launcher (baseline, no InsightReplay):
#   Qwen3-4B-Base + DAPO + DAPO-Math-15k, 128 GPUs (16 nodes x 8 H800).
#
# This is the exact recipe used for the baseline runs in the paper. It is
...
#
# Hyperparameters track the single-node `run_baseline.sh` recipe, scaled
# from 1 to 16 nodes.
# =============================================================================
import base64
...
exp_name = "Baseline-Qwen3-4B-Math-128gpu"
...
# ==========================================
# Sequence length config (aligned with run_baseline.sh)
# ==========================================
